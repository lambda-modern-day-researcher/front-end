        ...
        <div className="row">
          ...
          <div className="col-12 col-lg-10 col-xl-11">
            ...
            <ul className="list__categories">
              {this.props.categories && this.props.categories.map((category, i) => <CategoryIndicator key={i} name={category.name} color={category.color} />)}
            </ul>
...
module.exports = connect(mapStateToProps, { toggleLinkPriority, completeLink })(Link)
