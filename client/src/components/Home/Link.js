...
class Link extends Component {
  ...
  handleToggleLinkPriority = (event) => {
    this.props.toggleLinkPriority(this.props.current_user_id, this.state.id)
  }
      ...
      <styles.LinkStyle>
        <div className="row">
          <div className="col-12 col-lg-2 col-xl-1 d-flex">
            ...
            <svg onClick={this.handleToggleLinkPriority} className="control control__priority" style={(this.state.isPriority) ? { fill: 'red' } : { fill: '#AAA' }}
...
module.exports = connect(mapStateToProps, { toggleLinkPriority })(Link)
